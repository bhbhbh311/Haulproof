...
router.get('/:id', requireAuth, (req, res) => {
  ...
  const pods = db.prepare(`SELECT id, docType, filename, consignee, stopNumber, receiverName, signedAt, uploadedAt, status FROM pods WHERE loadId = ? ORDER BY (stopNumber IS NULL), stopNumber ASC, uploadedAt ASC`).all(load.id)
